...
--
-- INSTRUÇÕES:
-- 1. Acesse: https://supabase.com/dashboard/project/jsvdrmrfvlzeyskvprjv/sql
-- 2. Clique em "New query"
-- 3. Cole todo o conteúdo deste arquivo
-- 4. Clique em "Run" (ou Ctrl+Enter)
--
-- CONTEÚDO (em ordem de execução):
--   01 - Extensions e Types (ENUMs)
--   02 - Core Tables (master, construtoras, usuarios, empreiteiros)
